 ...
 */
public class SymptomFemaleFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (SymptomCheckerActivity.isBodyFront) {
            mBodyImage.setImageDrawable(getResources().getDrawable(R.drawable.female_front));
            mFrontTabLine.setVisibility(View.VISIBLE);
            mBackTabLine.setVisibility(View.INVISIBLE);
            mSkinText.setVisibility(View.GONE);
        } else {
            mBodyImage.setImageDrawable(getResources().getDrawable(R.drawable.female_back));
...
//        RelativeLayout.LayoutParams earRightLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(75, getActivity()), (int) Util.convertDpToPixel(50, getActivity()));
        ...
        if (width <= Constant.SCREEN_MIN_WIDTH && height <= Constant.SCREEN_MIN_HEIGHT) {
            headLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(65, getActivity()), (int) Util.convertDpToPixel(50, getActivity()));
        } else {
...
//        RelativeLayout.LayoutParams chestLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(60, getActivity()), (int) Util.convertDpToPixel(70, getActivity()));
        RelativeLayout.LayoutParams chestLayout = null;

        if (width <= Constant.SCREEN_MIN_WIDTH && height <= Constant.SCREEN_MIN_HEIGHT) {
            chestLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(50, getActivity()), (int) Util.convertDpToPixel(50, getActivity()));
        } else {
            chestLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(60, getActivity()), (int) Util.convertDpToPixel(70, getActivity()));
        }
...
//        RelativeLayout.LayoutParams abdomanLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(70, getActivity()), (int) Util.convertDpToPixel(65, getActivity()));
        ...
        if (width <= Constant.SCREEN_MIN_WIDTH && height <= Constant.SCREEN_MIN_HEIGHT) {
            ...
            abdomanLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(70, getActivity()), (int) Util.convertDpToPixel(65, getActivity()));
        }
...
//        RelativeLayout.LayoutParams leftHandLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(50, getActivity()), (int) Util.convertDpToPixel(120, getActivity()));
        ...
        if (width <= Constant.SCREEN_MIN_WIDTH && height <= Constant.SCREEN_MIN_HEIGHT) {
            ...
            leftHandLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(50, getActivity()), (int) Util.convertDpToPixel(120, getActivity()));
        }
...
//        RelativeLayout.LayoutParams rightHandLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(50, getActivity()), (int) Util.convertDpToPixel(120, getActivity()));
        ...
        if (width <= Constant.SCREEN_MIN_WIDTH && height <= Constant.SCREEN_MIN_HEIGHT) {
            ...
            rightHandLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(50, getActivity()), (int) Util.convertDpToPixel(120, getActivity()));
        }
        ...
        RelativeLayout.LayoutParams thightLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(80, getActivity()), (int) Util.convertDpToPixel(40, getActivity()));
...
//        RelativeLayout.LayoutParams legLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(80, getActivity()), (int) Util.convertDpToPixel(160, getActivity()));
        ...
        RelativeLayout.LayoutParams footLayout = new RelativeLayout.LayoutParams((int) Util.convertDpToPixel(80, getActivity()), (int) Util.convertDpToPixel(50, getActivity()));
...
//                break;
                ...
                case R.id.skin_text:
                    ...
                    Intent intent = new Intent(SymptomFemaleFragment.this.getActivity(), SymptomListActivity.class);
                ...
                case R.id.relative_head:
                    ...
                    mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_head_higlight));
                    ...
                    t.schedule(new TimerTask() {
                        ...
                        public void run() {
                            getActivity().runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.dummy_image));
                                    mBodyImage.setImageDrawable(getResources().getDrawable(R.drawable.head_face_female));
                                }
                            });
                        }
                    }, 50);
                ...
                case R.id.relative_chest:
                    ...
                    Intent chestIntent = new Intent(SymptomFemaleFragment.this.getActivity(), SymptomListActivity.class);
                    chestIntent.putExtra(Constant.SYMPTOM_BODY_CLASSIFIED, Constant.FEMALE_BODY);
                    if (SymptomCheckerActivity.isBodyFront) {
                        chestIntent.putExtra(Constant.SYMPTOM_BODY_PART, "?BodyArea=Chest");
                        mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_chest_highlight));
                    } else {
                ...
                case R.id.relative_abdomen:
                    ...
                    mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_abdomen_highlight));

                    Intent intentAbdom = new Intent(SymptomFemaleFragment.this.getActivity(), SymptomListActivity.class);
                    if (SymptomCheckerActivity.isBodyFront) {
                    ...
                    intentAbdom.putExtra(Constant.SYMPTOM_BODY_CLASSIFIED, Constant.FEMALE_BODY);
...
//                break;
                ...
                case R.id.relative_genital:
                    ...
                    mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_pelvis_higlight));

                    Intent intentGenital = new Intent(SymptomFemaleFragment.this.getActivity(), SymptomListActivity.class);
                    intentGenital.putExtra(Constant.SYMPTOM_BODY_PART, "?BodyArea=Genitals%20or%20Urinary");
                    intentGenital.putExtra(Constant.SYMPTOM_BODY_CLASSIFIED, Constant.FEMALE_BODY);
                ...
                case R.id.relative_leg:
                    if (SymptomCheckerActivity.isBodyFront) {
                        mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_legs_highlight));
                    } else {
                        mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_legs_highlight_back));
                    }
                    Intent intentLeg = new Intent(SymptomFemaleFragment.this.getActivity(), SymptomListActivity.class);
                    intentLeg.putExtra(Constant.SYMPTOM_BODY_PART, "?BodyRegion=Leg");
                    intentLeg.putExtra(Constant.SYMPTOM_BODY_CLASSIFIED, Constant.FEMALE_BODY);
                ...
                case R.id.relative_foot:
                    ...
                    Intent intentFoot = new Intent(SymptomFemaleFragment.this.getActivity(), SymptomListActivity.class);
                    intentFoot.putExtra(Constant.SYMPTOM_BODY_PART, "?BodyPart=Foot");
                    intentFoot.putExtra(Constant.SYMPTOM_BODY_CLASSIFIED, Constant.FEMALE_BODY);
                ...
                case R.id.relative_right_hand:
                    if (SymptomCheckerActivity.isBodyFront) {
                        mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_hand_higlight));
                    } else {
                        mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_hand_higlight_back));
                    }
                    Intent intentHand = new Intent(SymptomFemaleFragment.this.getActivity(), SymptomListActivity.class);
                    intentHand.putExtra(Constant.SYMPTOM_BODY_PART, "?BodyRegion=Arm");
                    intentHand.putExtra(Constant.SYMPTOM_BODY_CLASSIFIED, Constant.FEMALE_BODY);
                ...
                case R.id.relative_brain:
                    ...
                    mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_brain_highlight));

                    Intent brainHand = new Intent(SymptomFemaleFragment.this.getActivity(), SymptomListActivity.class);
                    brainHand.putExtra(Constant.SYMPTOM_BODY_PART, "?BodyArea=Head%20or%20Brain");
                    brainHand.putExtra(Constant.SYMPTOM_BODY_CLASSIFIED, Constant.FEMALE_BODY);
                ...
                case R.id.relative_eyes:
                    ...
                    mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_eyes_highlight));

                    Intent eyesHand = new Intent(SymptomFemaleFragment.this.getActivity(), SymptomListActivity.class);
                    eyesHand.putExtra(Constant.SYMPTOM_BODY_PART, "?BodyArea=Eye");
                    eyesHand.putExtra(Constant.SYMPTOM_BODY_CLASSIFIED, Constant.FEMALE_BODY);
                ...
                case R.id.relative_ears_right:
                    ...
                    mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_ears_highlight));

                    Intent earsLeftHand = new Intent(SymptomFemaleFragment.this.getActivity(), SymptomListActivity.class);
                    earsLeftHand.putExtra(Constant.SYMPTOM_BODY_PART, "?BodyArea=Ear");
                    earsLeftHand.putExtra(Constant.SYMPTOM_BODY_CLASSIFIED, Constant.FEMALE_BODY);
                ...
                case R.id.relative_nose:
                    ...
                    mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_nose_highlight));

                    Intent noseHand = new Intent(SymptomFemaleFragment.this.getActivity(), SymptomListActivity.class);
                    noseHand.putExtra(Constant.SYMPTOM_BODY_PART, "?BodyArea=Nose");
                    noseHand.putExtra(Constant.SYMPTOM_BODY_CLASSIFIED, Constant.FEMALE_BODY);
                ...
                case R.id.relative_mouth:
                    ...
                    mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_mouth_highlight));

                    Intent mouthHand = new Intent(SymptomFemaleFragment.this.getActivity(), SymptomListActivity.class);
                    mouthHand.putExtra(Constant.SYMPTOM_BODY_PART, "?BodyPart=Mouth");
                    mouthHand.putExtra(Constant.SYMPTOM_BODY_CLASSIFIED, Constant.FEMALE_BODY);
                ...
                case R.id.relative_neck:
                    ...
                    mBodyHighlightImage.setImageDrawable(getResources().getDrawable(R.drawable.female_neck_highlight));

                    Intent neckHand = new Intent(SymptomFemaleFragment.this.getActivity(), SymptomListActivity.class);
                    neckHand.putExtra(Constant.SYMPTOM_BODY_PART, "?BodyPart=Neck");
                    neckHand.putExtra(Constant.SYMPTOM_BODY_CLASSIFIED, Constant.FEMALE_BODY);
