...
package com.hackensack.umc.cropper.util;
...
public class ImageViewUtil {
    ...
    public Bitmap BITMAP_RESIZER(Bitmap bitmap,int newWidth,int newHeight,Rect rect) {
        Bitmap scaledBitmap = Bitmap.createBitmap(bitmap, rect.left, rect.top, newWidth,newHeight);
        ...
        canvas.drawBitmap(scaledBitmap, middleX - scaledBitmap.getWidth() / 2, middleY - scaledBitmap.getHeight() / 2, new Paint(Paint.FILTER_BITMAP_FLAG));
