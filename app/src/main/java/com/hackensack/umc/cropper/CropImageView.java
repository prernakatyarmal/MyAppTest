...
public class CropImageView extends FrameLayout {
     ...
     */
    private WeakReference<BitmapCroppingWorkerTaskOld> mBitmapCroppingWorkerTask;
    //endregion
    ...
    public void getCroppedImageAsync(CropShape cropShape, int reqWidth, int reqHeight) {
        ...
        BitmapCroppingWorkerTaskOld currentTask = mBitmapCroppingWorkerTask != null ? mBitmapCroppingWorkerTask.get() : null;
        if (currentTask != null) {
        ...
        mBitmapCroppingWorkerTask = mLoadedImageUri != null && mLoadedSampleSize > 1
              ? new WeakReference<>(new BitmapCroppingWorkerTaskOld(this, mLoadedImageUri, getActualCropRectNoRotation(), cropShape, mDegreesRotated, reqWidth, reqHeight))
               : new WeakReference<>(new BitmapCroppingWorkerTaskOld(this, mBitmap, getActualCropRect(), cropShape));
     ...
     */
    void onGetImageCroppingAsyncComplete(BitmapCroppingWorkerTaskOld.Result result) {
