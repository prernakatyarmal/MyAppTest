...
import com.hackensack.umc.fargment_manual_crop.ProfileIdInfoFragment;
import com.hackensack.umc.fargment_manual_crop.ProfileInsuranceInfoFragment;
...
public class ProfileSelfieManualCropActivity extends BaseActivity implements View.OnClickListener, ProfileInsuranceInfoFragment.OnFragmentInteractionListener, ProfileIdInfoFragment.OnFragmentInteractionListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.selfie_img:
                ...
                imageUri = CameraFunctionality.dispatchTakePictureIntent(ProfileSelfieManualCropActivity.this, 1, Constant.SELFIE);
                break;
                        ...
                        try {
                          ...
                          getImageUris(imageUri, 5,bmp,null);*/
                                   ...
                                   // String base64=Base64Converter.createBitmapFromFileImage(imageUri);
                                    String base64=Base64Converter.createBase64StringFromBitmap(bitmapImage,ProfileSelfieManualCropActivity.this);
                                    ...
                                    CameraFunctionality.setBitMapToImageView(imageUri.toString(), bitmapImage, imgSelfie, ProfileSelfieManualCropActivity.this);
                                    //pathSelfie = imageUri;
    ...
    public void onProceedButtonClicked() {
        if (checkValidationsBeforeCall()) {
            if (Util.ifNetworkAvailableShowProgressDialog(ProfileSelfieManualCropActivity.this, getString(R.string.scanning_images), true)) {
    ...
    private void getImageUris(Uri imageUri, int selectedImageView, Bitmap croppedbitmap, String base64FilePath) {
        ...
        switch (selectedImageView) {
            ...
            case 3:
                ...
                //imageUri = CameraFunctionality.saveCropedImage(croppedbitmap, ProfileSelfieManualCropActivity.this);
                uriIcFront = imageUri;
                break;
            case 4:
    ...
    private class GetAccessTokenCallDataMotion extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            String response = HttpUtils.getHttpGetResponse(ProfileSelfieManualCropActivity.this, ServerConstants.GET_CREDENTIALS_FOR_ACCESS_TOKEN, new CommonAPICalls(ProfileSelfieManualCropActivity.this).createTokenForDatamotionCall());
            ...
            if(datamotionTokenCredential!=null){
                return new CommonAPICalls(ProfileSelfieManualCropActivity.this).sendTokencallForDataMotion(datamotionTokenCredential);
            }
            return response;
        }
        ...
        protected void onPostExecute(String aVoid) {
            ...
            if (aVoid != null) {
                ...
                stopProgress();
                Util.showAlert(ProfileSelfieManualCropActivity.this, "Server error.Please try again.", "Alert");
            }
    ...
    private boolean checkValidationsBeforeCall() {
        ...
        if ((pathIcFront != null && pathIcBack == null) || (pathIcBack != null && pathIcFront == null)) {
            Util.showAlert(ProfileSelfieManualCropActivity.this, "Please attach insurance proof for front and back.", "Alert");
            return false;
        } else if (pathSelfie != null) {
            if ((pathDlFront == null || pathDlBack == null)) {

                Util.showAlert(ProfileSelfieManualCropActivity.this, "Please attach Id proof for front and back.", "Alert");
                return false;
            }
        }
        return true;
...
e.printStackTrace();
    ...
    private void setAllUrlsToNull() {
        CameraFunctionality.deleteImageAfterUploading(uriIcBack.toString(), ProfileSelfieManualCropActivity.this);
        CameraFunctionality.deleteImageAfterUploading(uriDlback.toString(),ProfileSelfieManualCropActivity.this);
        CameraFunctionality.deleteImageAfterUploading(uriDlFront.toString(), ProfileSelfieManualCropActivity.this);
        uriIcBack = null;
        uriDlback = null;
        uriDlFront = null;
    }
    ...
    private void showDilaog(String message) {
        Util.showAlert(ProfileSelfieManualCropActivity.this, getString(R.string.scan_fail_error) + "\n" + message, "Alert");
